1.
Here’s a **similar practice task** (same concepts: sub-mux, prefix routing, query params, clean separation), but slightly different so you actually learn instead of copying.
